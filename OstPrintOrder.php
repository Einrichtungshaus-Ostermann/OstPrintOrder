...
namespace OstPrintOrder;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstPrintOrder extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_print_order.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_print_order.view_dir', $this->getPath() . '/Resources/views/');
